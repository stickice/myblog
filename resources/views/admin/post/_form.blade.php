<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group row">
            ...
            <div class="col-md-8">
                <input class="form-control" name="publish_date" id="publish_date" type="text" value="{{ $publish_date }}" readonly="readonly">
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-md-8">
                <input class="form-control" name="publish_time" id="publish_time" type="text" value="{{ $publish_time }}" readonly="readonly">
            </div>
        </div>
        <div class="form-group row">
